<?php
	...
	$sql = "SELECT id, name, image, instructions, likes FROM recipe ORDER BY likes DESC LIMIT 4";
...
?>
		<div class="grids_of_2"><!-- start grids_of_2 -->	
				...
				<div id="da-slider" class="da-slider"><!-- start slider -->
						...
						while ($row = mysqli_fetch_assoc($query))
						{
							...
							echo "<div class='da-slide'>
								...
								<a href='recipe.php?id=$id'><h2>$name</h2></a>
								<p>$vsebina</p>
								</div>";
						}
						?>
			...
			<div class="clear"></div>
				...
				<ul>
					<li><a href="index.php"><i  class="icon_1"></i> <span>Popularni recepti</span></a></li>
