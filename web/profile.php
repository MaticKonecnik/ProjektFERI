...
?>
	<table id="userProfile">
		<?php	
			...
			if(isset($_SESSION['login']) && $id == $_SESSION['login']){
				echo '<tr><td colspan="2"><a href="#editProfile">Uredi profil</a></td></tr>';
			}
		?>
		<tr>
	...
	<a href="#_" class="lightbox" id="editProfile">
		<div class="clear"></div>
			...
			<div class="span_of_1"><!-- start span_of_1 -->
				...
				<div class="contact_form">
					<form method="post" autocomplete="off">
						...
						<span>Priimek</span>
						<input type="text" class="text" name="surname" value="<?php echo $row['surname']; ?>" />
						<span>Uporabniško ime</span>
						<input type="text" class="text" name="username" value="<?php echo $row['username']; ?>" />
						<span>E-mail</span>
						<input type="email" class="text" name="email" value="<?php echo $row['email']; ?>" />
						<div class="padd">
							<input type="reset" value="Preklici">
							<input type="submit" name="submit" value="Uredi">
							<div class="clear"></div>
						</div>
					</form>
				</div>			
