...
if (isset($_POST['vrednost'])) {
    $ids = $_POST['vrednost'];
    $vrednosti = explode(',', $ids); // oblika nekaj, nekaj; razrežimo v polje
  ...
  $string = "";
    ...
    for ($i = 0; $i < count($vrednosti); $i++) { // nato pa sestavinice
        if (is_numeric($vrednosti[$i])) { // èe je vrednost je to id sestavine
        ...
        } else { // drugaèe je ime in jo vpišemo v bazo
            ...
            <form method="post" autocomplete="off">
                ...
                <div id="dropbox">
                    <span class="message">Sem dodajte ENO fotografijo recepta <br />
                        <i>Še enkrat poglejte katero fotografijo boste naložili, kajti sprememba ni možna!<i/></span>
		</div>
                <div>
